...
QByteArray SerializeDeserializePacket::serializePacket(Packet& pocket) {
    return pocket.serializeData();
}

Packet& SerializeDeserializePacket::deserializePacket(QByteArray& bytesData, Packet& pocket) {
